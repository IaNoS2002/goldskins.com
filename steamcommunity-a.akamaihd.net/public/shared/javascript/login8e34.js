...
CLoginPromptManager.prototype.DoLogin = function()
{
	...
	$J.post( this.m_strBaseURL + 'getrsakey/', this.GetParameters( { username: username } ) )
		...
		.fail( function () {
			ShowAlertDialog( 'Σφάλμα', 'Υπήρξε ένα πρόβλημα κατά την επικοινωνία με τους διακομιστές του Steam. Παρακαλούμε δοκιμάστε ξανά αργότερα.' );
