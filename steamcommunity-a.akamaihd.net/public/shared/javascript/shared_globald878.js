...
{
	ShowConfirmDialog( 'Onko sinulla Steam?', 'Emme löytäneet käynnissä olevaa Steamiä tietokoneeltasi. Haluatko käynnistää verkkokeskustelun?',
		'Käytä verkkokeskustelua' , null, 'Lataa Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
