...
{
	ShowConfirmDialog( 'ดาวน์โหลด Steam หรือยัง?', 'เราไม่พบว่า Steam กำลังทำงานอยู่บนเครื่องของคุณ คุณต้องการจะเริ่มเปิดเว็บแชทหรือไม่?',
		'ใช้เว็บแชท' , null, 'ดาวน์โหลด Steam' ).done( function( choice ) {
			if ( choice == 'OK' )
				fnLaunchWebchat();
			else
