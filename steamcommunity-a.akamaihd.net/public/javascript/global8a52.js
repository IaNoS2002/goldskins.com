...
function checkAbuseSub( elForm )
{
	...
	$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', params).done( function() {
		ShowAlertDialog( 'Dziękujemy!', 'Dziękujemy za zgłoszenie obraźliwych treści i pomoc w utrzymaniu serwisu Steam w ładzie i przyjaznej atmosferze.' );
	}).fail( function() {
...
function ReportProfile( steamID )
{
	...
	var $Modal = ShowDialog( 'Zgłoś profil', $Content );
			...
			new Ajax.Request( _$this.GetActionURL( 'updateanswer' ), {
				...
				onFailure: function( transport ) {
					if ( transport.responseJSON && transport.responseJSON.success )
					{
						...
						{
							strError = 'Nie posiadasz uprawnień do aktualizowania odpowiedzi w tym wątku.'
						}
