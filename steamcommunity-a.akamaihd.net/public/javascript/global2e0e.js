...
function ReportProfile( steamID )
{
	...
	var $Modal = ShowDialog( 'Rapporter profil', $Content );
...
function ChangeLanguage( strTargetLanguage, bStayOnPage )
{
	...
	$J.post( 'https://steamcommunity.com/actions/SetLanguage/', {language: strTargetLanguage, sessionid: g_sessionID })
		.done( function() {
			...
			Modal.Dismiss();
			ShowAlertDialog( 'Bytt språk', 'Det oppstod et problem under kommunikasjon med Steams tjenere. Prøv igjen senere.' );
		});
}
